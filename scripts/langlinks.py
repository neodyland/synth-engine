...
print("execed")
engine = create_engine("mysql+pymysql://root:root@127.0.0.1:3307/root?charset=utf8mb4")
df = pl.read_database(
...
con = duckdb.connect(data / "langlinks.duckdb")
